...
ActiveRecord::Schema.define(version: 20160812043159) do
  ...
  add_index "average_caches", ["rater_id", "rateable_id"], name: "index_average_caches_on_rater_id_and_rateable_id", using: :btree
